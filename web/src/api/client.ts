...
export const api = {
  ...
  voicePack: () => request<VoicePackProgress>("/api/voice/pack"),
  startVoicePack: () => request<VoicePackProgress>("/api/voice/pack", { method: "POST" }),
  cancelVoicePack: () => request<VoicePackProgress>("/api/voice/pack", { method: "DELETE" }),
